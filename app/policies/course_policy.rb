...
module Tyto
  ...
  class CoursePolicy
    ...
    def can_view?               = account_is_enrolled? || account_is_admin?
    def can_edit?               = account_is_teaching_staff? || account_is_admin?
    def can_delete?             = account_is_owner? || account_is_admin?
    def can_enroll?             = account_is_teaching_staff? || account_is_admin?
    def can_record_attendance?  = account_is_student?
